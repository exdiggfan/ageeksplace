...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : (""))];
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/var/www/claytonsftpserver.ddns.net/drupal-8.6.9/themes/bootstrap/templates/input/input--button.html.twig");
    }
}
